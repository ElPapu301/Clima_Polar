...
<head>
    ...
    <title>Secretaria Ventas - Compra y Ventas, Pedidos y Envíos</title>
    <link rel="stylesheet" href="/equipo3/styles/styles_admin.css"> <!-- Usar la misma hoja de estilos -->
...
<body>
    ...
    <!-- Barra lateral -->
    <div class="sidebar">
        <a href="secretaria_ventas.php"><i class="fa-solid fa-house"></i> Inicio</a>
